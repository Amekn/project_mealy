...
- Status: the exact v0.1.1 schema-16 runtime passed its long-duration gate; publication gates remain
- Reviewed: 2026-07-24
...
The report-bearing commit still needs protected CI, reviewed free OpenRouter acceptance, native
package/public-download verification, and attested publication. Owner-local private-provider
