...
OpenAI's maintained `gpt-5.6` alias and a conservative 128,000-token Mealy context ceiling. The
...
cover strict free-OpenRouter catalog/probe behavior, the supported Codex subscription client,
Claude subscription rejection, credential containment, clean-home configuration, and idempotent
refusal. This is next-release source
