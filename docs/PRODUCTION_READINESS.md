...
package/public-download verification, and attested publication. Private-local-provider acceptance
is additional operator evidence and not substituted for the required public free-model gate.
