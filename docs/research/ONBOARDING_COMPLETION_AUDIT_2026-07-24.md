...
- credential values are imported once from the named environment variable or, only on terminal
  ...
  config, service environments, official subscription clients, and diagnostics;
